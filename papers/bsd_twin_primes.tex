...
I mined $1,004,800,003$ twin primes in the range $[10^{15}, 10^{15} + 10^{13}]$ and computed $k_{\text{real}}$ for each. The observed distribution:
\begin{center}
...
Therefore: $p \equiv 2^{k+1} - 1 \equiv k^2 - 1 \pmod{k^2}$ \qed
