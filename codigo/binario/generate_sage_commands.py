...
for i, p in enumerate(primos[:20]):  # Só 20 para teste rápido
    ...
    print(f"    print(f'✓ p={p}, k={k}, rank={{rank}}, L/Ω={{L_value}}')")
    print(f"except Exception as e:")
    print(f"    print(f'✗ p={p}, k={k}: {{e}}')")
    print()
...
print("        print('🏆 CORRELAÇÃO FORTÍSSIMA! rank ≈ k_real')")
print("    elif abs(r_corr) > 0.7:")
print("        print('✓ CORRELAÇÃO FORTE')")
print("    else:")
print("        print('⚠ Correlação moderada')")
